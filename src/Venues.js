...
componentDidMount() {
  ...
  setQuery = e => {this.setState({ [e.target.name]: e.target.value })}
...
//
renderResults = () => {
return this.state.venues.map(venue => <ItemCard key={venue.id} venue={venue} photo_url={venue.photo.prefix + '400x400' + venue.photo.suffix}/>)
}
